...
public interface MeetingProposer {
    ...
    @UserMessage("""
        Propose a new meeting time for a 3h meeting on topic {{meetingTopic}}.
        Write your proposal as a single sentence, like:
        "Would you be available on Monday at 10am?"
        You are available at the following times: tomorrow all morning, the day after all afternoon, 
        next week same days but then available all day.
        Today is Monday 12 September.
        """)
    // TODO put date instead of hardcoded
    String propose(@MemoryId String memoryId, @V("meetingTopic") String meetingTopic);
}
