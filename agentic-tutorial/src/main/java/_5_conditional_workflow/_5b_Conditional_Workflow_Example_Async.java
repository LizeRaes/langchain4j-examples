...
public class _5b_Conditional_Workflow_Example_Async {
     ...
     * In this example, when the HrReview is good, the CV is passed to the manager for review,
     * and when the HrReview indicates missing information, the candidate is contacted for more info.
     */
    ...
    public static void main(String[] args) throws IOException {
        ...
        ManagerCvReviewer managerCvReviewer = AgenticServices.agentBuilder(ManagerCvReviewer.class)
                ...
                // TODO async leads to errors. check email on the topic. also check parallel executor thing that didn't work when undefined executor
