...
public class _2d_Agentic_Scope_Example {
    ...
    public static void main(String[] args) throws IOException {
        ...
        SequenceCvGeneratorWScope sequenceCvGenerator = AgenticServices
                .sequenceBuilder(SequenceCvGeneratorWScope.class) // here we specify the typed interface
                ...
                .output(agenticScope -> { // any method is possible, but we collect some internal variables.
                    Map<String, Object> bothCvsAndLifeStory = Map.of(
        ...
        ResultWithAgenticScope<Map<String,Object>> bothCvsAndScope = sequenceCvGenerator.generateTailoredCv(lifeStory, instructions);

        // 7. Extract result and agenticScope
        AgenticScope agenticScope = bothCvsAndScope.agenticScope();
        Map<String,Object> bothCvsAndLifeStory = bothCvsAndScope.result();

        System.out.println("=== USER INFO (input) ===");
        String userStory = (String) bothCvsAndLifeStory.get("lifeStory");
        ...
        String masterCv = (String) bothCvsAndLifeStory.get("masterCv");
        ...
        Cv tailoredCv = (Cv) bothCvsAndLifeStory.get("tailoredCv");
        ...
        System.out.println("=== AGENT INVOCATIONS (all sub-agent calls) ===");
        System.out.println("*** CvGenerator ***");
        System.out.println(AgenticScopePrinter.printAgentInvocations(agenticScope.agentInvocations("generateCv"), 100));
        System.out.println("*** CvTailor ***");
        System.out.println(AgenticScopePrinter.printAgentInvocations(agenticScope.agentInvocations("tailorCv"), 100));
